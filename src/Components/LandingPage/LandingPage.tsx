...
const LandingPage: React.FC<LandingPageProps>  = ({ handleLoginClick }) => {
    ...
    return (
        <div className="h-screen tracking-tight overflow-x-hidden">
            ...
            {/* levelup  section*/}
            <div ref={levelUpSectionRef} className={`hidden lg:flex flex-col justify-center items-center h-[520px] ml-8 transition-opacity ease-in duration-300 ${isLevelUpSectionVisible? "slide-top2" : "opacity-0"}`}>
            ...
            {/* What is LifeXP */}
            <div ref={aboutSectionRef} className={`h-[620px] mt-20 sm:mt-16  mb-10  flex flex-col justify-center items-center space-y-8 lg:space-y-16 transition-opacity ease-in duration-300 ${isAboutSectionVisible? "slide-top2" : "opacity-0"}`}>
